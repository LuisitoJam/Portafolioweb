...
if($_POST){
    ...
    $sentencia=$conexion->prepare("UPDATE tbl_portafolio 
     ...
     if ($_FILES["imagen"]["tmp_name"] != "") {
      ...
      move_uploaded_file($tmp_imagen, "../../../assets/img/portfolio/" . $imagen);
      ...
      // Actualización del nombre de la imagen en la base de datos
      $sentencia = $conexion->prepare("UPDATE tbl_portafolio SET imagen=:imagen WHERE id=:id ");
      $sentencia->bindParam(":imagen", $imagen);  // Usar la variable $imagen aquí
      $sentencia->bindParam(":id", $txtID);
      $sentencia->execute();
  }
